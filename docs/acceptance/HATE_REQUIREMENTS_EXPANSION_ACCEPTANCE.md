---
intent_id: INT-HATE-REQUIREMENTS-EXPANSION-ACCEPTANCE-001
owner: RNA4219
status: active
...
|---|---|---|---|---|
| AC-HATE-GAP-027 | HATE-GAP-027 | onboarding fixtures and onboarding-uat-report.json | implemented | connected to expansion runner and release pack |
| AC-HATE-GAP-028 | HATE-GAP-028 | policy simulation fixtures and policy-simulation-uat-report.json | implemented | connected to expansion runner and release pack |
| AC-HATE-GAP-029 | HATE-GAP-029 | bulk portability fixtures and bulk-portability-uat-report.json | implemented | connected to expansion runner and release pack |
| AC-HATE-GAP-030 | HATE-GAP-030 | notification fixtures and notification-uat-report.json | implemented | connected to expansion runner and release pack |
| AC-HATE-GAP-031 | HATE-GAP-031 | self-hosted fixtures and self-hosted-uat-report.json | implemented | connected to expansion runner and release pack |
| AC-HATE-GAP-032 | HATE-GAP-032 | data classification fixtures and data-classification-uat-report.json | implemented | connected to expansion runner and release pack |
| AC-HATE-GAP-033 | HATE-GAP-033 | docs lifecycle fixtures and docs-lifecycle-uat-report.json | implemented | connected to expansion runner and release pack |
| AC-HATE-GAP-034 | HATE-GAP-034 | dependency compliance fixtures and dependency-compliance-uat-report.json | implemented | connected to expansion runner and release pack |
| AC-HATE-GAP-035 | HATE-GAP-035 | adapter marketplace fixtures and adapter-marketplace-uat-report.json | implemented | connected to expansion runner and release pack |
| AC-HATE-GAP-036 | HATE-GAP-036 | product analytics fixtures and product-analytics-uat-report.json | implemented | connected to expansion runner and release pack |
| AC-HATE-GAP-037 | HATE-GAP-037 | disaster recovery fixtures and disaster-recovery-uat-report.json | implemented | connected to expansion runner and release pack |
...
| AC-HATE-GAP-052 | HATE-GAP-052 | oracle classification fixtures and oracle-classification-uat-report.json | implemented | connected to expansion runner and release pack |
| AC-HATE-GAP-053 | HATE-GAP-053 | evidence synthesis fixtures and evidence-synthesis-uat-report.json | implemented | connected to expansion runner and release pack |
| AC-HATE-GAP-054 | HATE-GAP-054 | test quality fixtures and test-quality-uat-report.json | implemented | connected to expansion runner and release pack |
| AC-HATE-GAP-055 | HATE-GAP-055 | environment diff fixtures and environment-diff-uat-report.json | implemented | connected to expansion runner and release pack |
| AC-HATE-GAP-056 | HATE-GAP-056 | contradiction detection fixtures and contradiction-uat-report.json | implemented | connected to expansion runner and release pack |
| AC-HATE-GAP-057 | HATE-GAP-057 | historical regression fixtures and historical-regression-uat-report.json | implemented | connected to expansion runner and release pack |
| AC-HATE-GAP-058 | HATE-GAP-058 | audience report pack fixtures and audience-report-pack-uat-report.json | implemented | connected to expansion runner and release pack |
| AC-HATE-GAP-059 | HATE-GAP-059 | fixture quality fixtures and fixture-quality-uat-report.json | implemented | connected to expansion runner and release pack |
| AC-HATE-GAP-060 | HATE-GAP-060 | adapter capability diff fixtures and adapter-capability-diff-uat-report.json | implemented | connected to expansion runner and release pack |

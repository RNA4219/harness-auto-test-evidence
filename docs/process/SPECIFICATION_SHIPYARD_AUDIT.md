...
| AUD-SHIP-019 | P2/P3 product readiness artifact は未実装だった | `hate product readiness`、product readiness report、hosted read model index、enterprise metrics、docs/support/privacy/governance artifacts、P2/P3 minimal fixture を advisory artifact として追加 | closed |
| AUD-SHIP-020 | product-grade 実装完了と advisory artifact 実装完了の境界が曖昧だった | `PRODUCT_GRADE_IMPLEMENTATION_SPEC.md` を追加し、adapter corpus、store replay、API、dashboard、RBAC/audit/retention、enterprise connector、support/ops evidence が未完了なら product-ready としないルールを固定 | closed |
...
- P2/P3 product readiness / hosted read model index / enterprise metrics / docs / support / privacy / governance artifact の advisory 実行回帰が存在する
...
- product-grade 実装完了は別ゲートであり、`PRODUCT_GRADE_IMPLEMENTATION_SPEC.md` の evidence reports が揃うまで product-ready / enterprise-ready と主張しない

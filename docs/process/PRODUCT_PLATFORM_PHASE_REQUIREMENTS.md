...
| PPH-GRADE-003 | PoC completion is a separate readiness axis from production release readiness. | PoC may be 100% when every residual friction has mitigation and non-overclaim guardrails, while `product_ready` remains false. |

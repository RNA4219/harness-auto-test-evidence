...
- [POST_POC_REQUIREMENTS_GAP_AUDIT.md](docs/process/POST_POC_REQUIREMENTS_GAP_AUDIT.md)
- [POST_POC_PRODUCTIZATION_DETAIL_SPEC.md](docs/process/POST_POC_PRODUCTIZATION_DETAIL_SPEC.md)
- [POST_POC_SPEC_TRACEABILITY_CHECKLIST.md](docs/process/POST_POC_SPEC_TRACEABILITY_CHECKLIST.md)
- [POST_POC_IMPLEMENTATION_GAP_CHECKLIST.md](docs/process/POST_POC_IMPLEMENTATION_GAP_CHECKLIST.md)
...
- Post-PoC 要件ギャップ: PoC 100% は product / enterprise / regulated 要件完了を意味しない。残る productization debt は `docs/process/POST_POC_REQUIREMENTS_GAP_AUDIT.md` を正本とし、product-grade summary に known gap count として出す。
